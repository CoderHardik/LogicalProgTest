 ...
 */
public class ValidUserNameHarckerrankRegex {
	public static final String regularExpression = "^[a-zA-Z][\\w]{7,29}$";//This prgram does not work but this regex is imp line of whole thing
...
private static final Scanner scan = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        while (n-- != 0) {
            ...
            if (userName.matches(ValidUserNameHarckerrankRegex.regularExpression)) {
